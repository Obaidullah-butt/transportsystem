...
<div class="overlay">
    <div class="dashboard-container">
        ...
        <a href="{{ route('admin.pendingVehicles') }}" class="dashboard-button">Pending Vehicle Approvals</a>
        <a href="{{ route('admin.availableVehicles') }}" class="dashboard-button">Available Vehicles</a>
         <a href="{{ route('admin.seetrip') }}" class="dashboard-button">Trip</a>
